...
import net.arxemond.springsecurityapp.model.Shop;
import net.arxemond.springsecurityapp.model.Student;
import net.arxemond.springsecurityapp.model.StudentList;
...
public class APIController
{
    ...
    public @ResponseBody StudentList getStudentListXML() {
